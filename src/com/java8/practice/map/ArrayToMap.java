...
public class ArrayToMap {
    ...
    public static void main(String[] args) {
       ...
       Map<Integer,Integer> map1= Arrays.stream(arr).collect(Collectors.toMap(Function.identity(), Function.identity()));
        ...
        Map<Integer,Integer> map2= Arrays.stream(arr1).collect(Collectors.toMap(Function.identity(), Function.identity(), (x,y)->x+y));
        System.out.println(map2);

        // this is the 3rd way, it will
        Integer[] arr3={1,1,4,6,7,8,19,45,-1,56};
        Map<Integer,Integer> map3= Arrays.stream(arr1).collect(Collectors.toMap(Function.identity(), Function.identity(), (x,y)->x+y, TreeMap::new));
